#include "Arduino.h"
#ifndef _SimpleMPU9250_H_
#define _SimpleMPU9250_H_
...
//#define MPU9250_DEFAULT_ADDRESS     MPU9250_ADDRESS_AD0_HIGH	// my MPU9150
#define MPU9250_DEFAULT_ADDRESS     MPU9250_ADDRESS_AD0_LOW	// my MPU9250
...
public:
	...
	void getRawMotion6(int16_t* data);
	//void getRawCompass(float* mx, float* my, float* mz);
	void getRawCompass(int16_t* data);
private:
	uint8_t buffer[14];
};
#endif
